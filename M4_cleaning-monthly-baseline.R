...
write.csv2(m4[m4$dishes>0,c("HHID", "date_visit", "FRA","ppl","other_water_in.wash_plate_in",
                                      "other_water_out.wash_plate_out")],file="Washed dishes.csv")

m4[m4$dishes>0,c("HHID")]

m4$clothes<-with(m4,(other_water_in.wash_clothes_in+other_water_out.wash_clothes_out))
